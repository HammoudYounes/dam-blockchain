        ...
        <main className="p-10 min-h-screen">
            ...
            <div className="flex flex-row gap-10 py-6">
                <div className="flex-1 flex flex-col gap-3">
                    <div className="text-gray-400 text-sm font-plex">Network</div>
                ...
                <div className="flex-1 flex flex-col gap-3">
                    <div className="text-gray-400 text-sm font-plex">Contract deployed</div>
                    <div className="text-lg">3 / 3</div>
                </div>
                <div className="flex-1 flex flex-col gap-3">
                    <div className="text-gray-400 text-sm font-plex">Assets registered</div>
                    <div className="text-lg">55555</div>
                </div>
                <div className="flex-1 flex flex-col gap-3">
                    <div className="text-gray-400 text-sm font-plex">Verifications runs</div>
