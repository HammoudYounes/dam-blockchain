"""
Benchmark pHash: find the optimal Hamming-distance threshold that maximises
...
HASH_BITS = 63  # 8×8 DCT low-freq block minus the DC component
...
def main():
    print("=" * 70)
    print("pHash Benchmark — Hamming Threshold Optimisation")
    ...
    sweep_csv = RESULTS_DIR / "phash_threshold_sweep.csv"
    ...
    transform_csv = RESULTS_DIR / "phash_per_transform.csv"
    ...
    pairs_csv = RESULTS_DIR / "phash_pair_distances.csv"
