...
def run_benchmark():
    ...
    output_csv = os.path.join(RESULTS_DIR, "own_detailed_results.csv")
...
def print_summary(results):
    ...
    # Write summary CSV
    summary_csv = os.path.join(RESULTS_DIR, "own_summary_by_transformation.csv")
